package com.coding.qzy.baselibrary.widget.viewpagerindicator.bar
...
class BarViewPagerIndicator(ctx: Context, attrs: AttributeSet) : ViewPagerIndicator<RectF>(ctx, attrs) {
    ...
    init {
        ...
        selectPaint.style = Paint.Style.FILL_AND_STROKE
        selectPaint.color = resources.getColor(R.color.def_bar_red_color)
    }
