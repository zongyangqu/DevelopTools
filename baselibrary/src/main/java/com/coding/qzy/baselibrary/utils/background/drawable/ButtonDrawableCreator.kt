...
class ButtonDrawableCreator(private val typedArray: TypedArray, private val buttonTa: TypedArray) : ICreateDrawable {
    ...
    @Throws(Exception::class)
    private fun setSelectorDrawable(typedArray: TypedArray, buttonTa: TypedArray,
