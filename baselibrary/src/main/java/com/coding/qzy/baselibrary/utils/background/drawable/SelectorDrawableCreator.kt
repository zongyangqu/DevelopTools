...
class SelectorDrawableCreator(private val typedArray: TypedArray, private val selectorTa: TypedArray) : ICreateDrawable {
    ...
    @Throws(Exception::class)
    private fun setSelectorDrawable(typedArray: TypedArray, selectorTa: TypedArray,
        ...
        if (resDrawable == null && color != 0) {
            val tmpDrawable = getDrawable(typedArray)
