...
public class BadgeView extends androidx.appcompat.widget.AppCompatTextView {
    ...
    private static final int DEFAULT_BADGE_COLOR = 0xFFFF5000; //Color.RED;
    ...
    private void init(Context context, View target, int tabIndex) {
        ...
        badgeMarginH = dip2px(context, (float) DEFAULT_MARGIN_DIP);
        badgeMarginV = badgeMarginH;
        badgeColor = DEFAULT_BADGE_COLOR;

        setTypeface(Typeface.DEFAULT);
        int paddingPixels = dip2px(context, (float) DEFAULT_LR_PADDING_DIP);
    ...
    private ShapeDrawable getDefaultBackground() {
        int r = dip2px(context, (float) DEFAULT_CORNER_RADIUS_DIP);
    ...
    public void setTextCount(int cartCount) {
        String text = null;
        try {
            text = String.valueOf(cartCount);
        } catch (Exception e) {
        }
