...
/**
 * CreateDate:2021/9/26 18:01
 * @author: zongyang qu
 * @Package： cn.yonghui.hyd.member.wigets.loopview
 * @Description:
 */
class LoopBannerViewPager<T> : RelativeLayout, LifecycleObserver {

    private var mContext: Context = context
    private lateinit var mIndicatorLayout: LinearLayout
    private lateinit var mViewPager: ViewPager2
    private var mBannerPagerAdapter: BaseLoopBannerAdapter<T, *>? = null
    ...
    private var mOnPageClickListener: BaseLoopBannerAdapter.OnPageClickListener? = null
     ...
     * 指示器间隔
     */
    private var indicatorMargin = dpToPx(3)

    /**
     * 正常指示器图片
     */
    private var normalImage = R.drawable.bg_shape_loop_dot

    /**
     * 选中指示器图片
     */
    private var checkedImage = R.drawable.bg_shape_loop_dot_selected
    ...
    private fun initView() {
        inflate(context, R.layout.common_loop_bvp_layout, this)
     ...
     */
    fun setLifecycleRegistry(lifecycleRegistry: Lifecycle): LoopBannerViewPager<T> {
     ...
     * @return
     */
    fun setAutoPlay(autoPlay: Boolean): LoopBannerViewPager<T> {
        isAutoPlay = autoPlay
        return this
    }
     ...
     * @return
     */
    fun setCanLoop(canLoop: Boolean): LoopBannerViewPager<T> {
        isLooper = canLoop
        return this
    }
     ...
     * @return
     */
    fun setAdapter(adapter: BaseLoopBannerAdapter<T, *>?): LoopBannerViewPager<T> {
     ...
     * @return
     */
    fun setInterval(int: Int): LoopBannerViewPager<T> {
        interval = int * 1000L
        return this
    }
     ...
     * @return
     */
    fun setOffscreenPageLimit(int: Int): LoopBannerViewPager<T> {
     ...
     *
     */
    fun setCanShowIndicator(bool: Boolean): LoopBannerViewPager<T> {
     ...
     * @return
     */
    fun setPageTransformer(transformer: ViewPager2.PageTransformer): LoopBannerViewPager<T> {
     ...
     */
    fun addPageTransformer(transformer: ViewPager2.PageTransformer): LoopBannerViewPager<T> {
     ...
     */
    fun setPageMargin(margin: Int): LoopBannerViewPager<T> {
     ...
     * 一屏多页模式下两边页面显露出来的宽度
     */
    fun setRevealWidth(int: Int): LoopBannerViewPager<T> {
     ...
     */
    fun setOnPageClickListener(onPageClickListener: BaseLoopBannerAdapter.OnPageClickListener): LoopBannerViewPager<T> {
     ...
     *
     */
    fun setIndicatorMargin(margin: Int): LoopBannerViewPager<T> {
