package com.coding.qzy.baselibrary.utils.text;
...
public class ColorPhraseUtils {
    ...
    public static ColorPhraseUtils from(Fragment f, int patternResourceId) {
     ...
     *             if pattern contains any syntax errors.
     */
    public static ColorPhraseUtils from(View v, int patternResourceId) {
     ...
     *             if pattern contains any syntax errors.
     */
    public static ColorPhraseUtils from(Context c, int patternResourceId) {
     ...
     *             if pattern contains any syntax errors.
     */
    public static ColorPhraseUtils from(Resources r, int patternResourceId) {
     ...
     *             if pattern contains any syntax errors.
     */
    public static ColorPhraseUtils from(CharSequence pattern) {
        return new ColorPhraseUtils(pattern);
    }

    private ColorPhraseUtils(CharSequence pattern) {
     ...
     * @return
     */
    public ColorPhraseUtils withSeparator(String _separator) {
     ...
     * @return
     */
    public ColorPhraseUtils outerColor(int _outerColor) {
     ...
     * @return
     */
    public ColorPhraseUtils innerColor(int _innerColor) {
