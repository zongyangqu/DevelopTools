...
import com.quzy.coding.util.GlideCircleTransform;

/**
 * CreateDate:2021/11/23 18:28
 *
 * @author: zongyang qu
 * @Package： com.quzy.coding.util.widget
 * @Description:
...
public class CnToolbar extends Toolbar {
    ...
    private void setUserName(@Nullable AttributeSet attrs, int defStyleAttr){
        if(attrs != null){
            @SuppressLint("RestrictedApi") final String rightIcon = b.getString( R.styleable.CnToolbar_userName );
    ...
    private void setUserPhoto(@Nullable AttributeSet attrs, int defStyleAttr){
        if(attrs != null){
            @SuppressLint("RestrictedApi") final Drawable leftIcon = b.getDrawable(R.styleable.CnToolbar_userPhotoIcon);
            if (leftIcon != null) {
    ...
    public void setUserPhotoIcon(Context context , String resId , int defResId){
        if( resId != null && resId.length() > 0){
            ...
            Glide.with(context).load(resId).transform(new GlideCircleTransform()).into(this.userPhoto);
        }else {
    ...
    public void setUserPhotoClickListener (View.OnClickListener listener) {
    ...
    public void setRightButton(@Nullable AttributeSet attrs, int defStyleAttr){
        if(attrs != null){
            @SuppressLint("RestrictedApi") final String rightIcon = b.getString( R.styleable.CnToolbar_rightButtonText );
            if (rightIcon != null && rightIcon.length()>0) {
    ...
    public void setRightButtonIcOnClickListener (View.OnClickListener listener) {
        mRightButton.setOnClickListener(listener);
    }

    public void setLeftButton(@Nullable AttributeSet attrs, int defStyleAttr){
        if(attrs != null){
            @SuppressLint("RestrictedApi") final Drawable leftIcon = b.getDrawable(R.styleable.CnToolbar_leftButtonIcon);
            if (leftIcon != null) {
    ...
    public void setLeftButtonIcOnClickListener (View.OnClickListener listener) {
    ...
    public void setRightImageButton(@Nullable AttributeSet attrs, int defStyleAttr){
        if(attrs != null){
            @SuppressLint("RestrictedApi") final Drawable rightImage = b.getDrawable(R.styleable.CnToolbar_rightImageButtonIcon);
            if (rightImage != null) {
    ...
    public void setRightImgeButtonIcOnClickListener (View.OnClickListener listener) {
        mRightImageButton.setOnClickListener(listener);
    }

    public boolean getIsShowSearchView(){
        @SuppressLint("RestrictedApi") final boolean isShowSearchView = b.getBoolean(R.styleable.CnToolbar_isShowSearchView , false) ;
