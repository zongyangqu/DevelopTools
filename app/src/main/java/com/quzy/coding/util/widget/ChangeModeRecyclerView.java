...
/**
 * CreateDate:2021/11/10 10:40
 *
 * @author: zongyang qu
 * @Package： com.quzy.coding.util.widget
 * @Description:
 */
public class ChangeModeRecyclerView extends RecyclerView {
    /**
     * item 类型
     */
    ...
    public ChangeModeRecyclerView(Context context) {
        super(context);
        init();
    }

    public ChangeModeRecyclerView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }

    public ChangeModeRecyclerView(Context context, AttributeSet attrs, int defStyle) {
