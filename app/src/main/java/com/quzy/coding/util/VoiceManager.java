...
public class VoiceManager {
                    ...
                    case MSG_TIME_INTERVAL:
                        if (mDeviceState == MEDIA_STATE_RECORD_DOING) {
                            ...
                            if (voiceRecordCallBack != null) {
                                ...
                                voiceRecordCallBack.recDoing(mRecTimeSum, DateUtil.timeParse2ms(mRecTimeSum*1000));
                            }
    ...
    public boolean isRecoreing(){
        return mDeviceState == MEDIA_STATE_RECORD_DOING || mDeviceState == MEDIA_STATE_RECORD_PAUSE;
    }
            ...
            if (mRecTimeSum <= 1) {
                ...
                if (file != null && file.length() > 0) {
                    ...
                    if (voiceRecordCallBack != null) {
                        ...
                        voiceRecordCallBack.recFinish(mRecTimeSum, DateUtil.timeParse2ms(mRecTimeSum*1000),file.getAbsolutePath());
                    }
                }
            }
